...
public class FirstSongTeleOp extends OpMode {
    ...
    private ElapsedTime noteTime = new ElapsedTime();
    public static int BPM = 120;
    private double wholeNote = BPM/15;
    private double halfNote = BPM/30;
    private double quarterNote = BPM/60;
    private double eighthNote = BPM/120;
    private double sixteenthNote = BPM/240;
